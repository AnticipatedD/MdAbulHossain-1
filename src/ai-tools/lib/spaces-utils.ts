...
/**
 * Parse a Copilot Space API URL into org and id.
...
/**
 * Fetch a Copilot Space from GitHub API.
...
/**
 * Convert a Copilot Space into a markdown prompt string.
 */
export function convertSpaceToPrompt(space: SpaceData): string {
  ...
  if (space.resources_attributes?.length) {
